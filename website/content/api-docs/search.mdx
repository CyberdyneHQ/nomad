...
```json
{
  ...
  "Matches": {
    "services": [
      {
        "ID": "python-logger",
        "Scope": ["default", "example-python", "my-spy-app", "my-python-task"]
      },
      {
        "ID": "super-spy-service",
        "Scope": ["default", "example-python", "my-spy-app"]
      }
    ],
    "tasks": [
      {
...
```json
{
  ...
  "Matches": {
    "nodes": [
      {
        "ID": "nomad-lab1",
        "Scope": ["c48cd39f-dfe1-9cc0-9c62-617d199854be"]
      }
    ]
  },
  "Truncations": {
    ...
    "allocs": [
      {
        ...
        "Scope": ["default", "0fb703d1-ba4d-116f-13aa-27f31f046858"]
      }
    ]
  },
  "Truncations": {
...
```json
{
  ...
  "Matches": {
    ...
    "allocs": [
      {
        "ID": "example-python.my-spy-app[0]",
        "Scope": ["default", "48608246-4c28-0446-f3d1-c67e3bc650ad"]
      }
    ]
  },
  "Truncations": {
