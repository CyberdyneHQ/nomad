  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        capacity, in MB. Omitted if task isn't configured with memory
        oversubscription.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        ...
        Omitted if the the task does not request cpu cores. E.g.{" "}
        <code>0-2,7,12-14</code>
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        Job's ID, which is equal to the Job name when submitted through CLI but
        can be different when using the API
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        ...
        and <code>task</code> for tasks in the same task group. Only available when
    ...
    <tr>
      ...
      <td>
        ...
        when a port map is used, otherwise the host's static or dynamic port allocation.
        Services should bind to this port. Only available when setting ports via
        the task resource network port mapping.
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        ...
        Only available when setting ports via the task resource network port mapping.
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        ...
        <code>task</code> for tasks in the same task group. Only available when setting
    ...
    <tr>
      ...
      <td>
        ...
        set to a unix domain socket in bridge networking mode, or a tcp address
    ...
    <tr>
      ...
      <td>
        ...
        Will be automatically set to true if Nomad is configured to communicate
        with Consul using TLS.
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        ...
        Will be automatically set if Nomad is configured with the{" "}
        <code>consul.share_ssl</code>
        option.
      </td>
    </tr>
    <tr>
      ...
      <td>
        Specifies the path to the Client certificate used for Consul
        communication. Will be automatically set if Nomad is configured with the{" "}
        <code>consul.share_ssl</code>
        option.
      </td>
    </tr>
    <tr>
      ...
      <td>
        Specifies the path to the CLient Key certificate used for Consul
        communication. Will be automatically set if Nomad is configured with the{" "}
        <code>consul.share_ssl</code>
        option.
      </td>
    ...
    <tr>
      ...
      <td>
        Specifies the server name to use as the SNI host for Consul
        communication. Will be automatically set if Consul is configured to use
        TLS and the task is in a group using bridge networking mode.
      </td>
    </tr>
  </tbody>
</table>
