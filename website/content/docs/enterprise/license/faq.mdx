...
- [v1.1.0 Upgrade Guide](https://www.nomadproject.io/docs/upgrade/upgrade-specific#enterprise-licenses)

- [Nomad License Documentation](https://www.nomadproject.io/docs/enterprise/license)

- [License configuration values documentation](https://www.nomadproject.io/docs/configuration/server#license_path)

- [Install a HashiCorp Enterprise License Tutorial](https://learn.hashicorp.com/tutorials/nomad/hashicorp-enterprise-license)
